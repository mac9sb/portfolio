                    ...
                    Stack {
                        ...
                        Stack {
                            Text("LOC: London, UK & Remote")
                                .font(size: .xs2, weight: .bold, tracking: .wide, casing: .uppercase)
                        ...
                        .border(of: 1, at: .leading, color: .custom("rgba(0, 0, 0, 0.2)"))
                        ...
                        .on {
                            ...
                            $0.dark {
                                $0.border(of: 1, at: .leading, color: .custom("rgba(255, 255, 255, 0.2)"))
                            }
                        }
                    }
